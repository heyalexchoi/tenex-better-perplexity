          ...
          setLiveState((prev) => ({
            ...
            toolLines: [
              ...(prev?.toolLines ?? []),
              {
                ...
                thinking: parsed.data?.thinking ? String(parsed.data.thinking) : null,
                nextGoal: parsed.data?.next_goal ? String(parsed.data.next_goal) : null,
                evaluationPreviousGoal: parsed.data?.evaluation_previous_goal ? String(parsed.data.evaluation_previous_goal) : null,
                timestamp: parsed.timestamp,
              },
            ],
          }))
